...
> **版本**：V26
> **V26 升级**：新增标的类型识别（P0阶段即区分分析重点）+ 迭代数据采集
...
## Step 1b：扫描发现标的的类型预判（V26新增）

在板块热点中发现潜在标的时，先预判其类型：

| 预判类型 | 市值特征 | 典型板块 |
|---------|---------|---------|
| A.蓝筹大盘 | >500亿，大型指数成分 | 白酒、银行、龙头新能源 |
| B.成长题材 | 50-500亿，高增速 | AI芯片、半导体设备、新能源 |
| C.周期股 | 50亿+，强周期行业 | 有色、煤炭、钢铁、猪肉 |
| D.价值低估 | 50亿+，PB低 | 传统行业、困境行业 |
| E.困境反转 | 不限，ST/Risk或亏损 | 重组、转型的周期股 |
| F.未知/混合 | 不满足以上 | 新股、概念股 |

**预判后记录到扫描报告**，后续深度分析时再精准确认类型。
